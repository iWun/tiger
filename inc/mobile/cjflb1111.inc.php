...
global $_W, $_GPC;
       ...
       $weid=$_W['uniacid'];
		...
		$url="https://mo.m.taobao.com/union/yx1111?pid=".$pid."&cpsrc=tiger_tiger";
		$pic=$_W['siteroot']."addons/tiger_newhu/template/mobile/qtz/images/cjflb.png";
		$title="天猫超级福利榜";
...
// 							exit;
       ...
       include $this->template ( 'qtz/cjflb1111' );
?>
