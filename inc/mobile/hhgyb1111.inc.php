...
global $_W, $_GPC;
	  ...
	  $url="https://mo.m.taobao.com/union/1111_ys_gy?pid=".$pid."&cpsrc=tiger_tiger";
		$pic=$_W['siteroot']."addons/tiger_newhu/template/mobile/qtz/images/hhgyb.jpg";
		$title="好货高佣榜";
...
// 							exit;
       ...
       include $this->template ( 'qtz/hhgyb1111' );
?>
