...
global $_W, $_GPC;
       ...
       $weid=$_W['uniacid'];
		...
		$url="https://mos.m.taobao.com/union/super1111?pid=".$pid."&cpsrc=tiger_tiger";
		$pic=$_W['siteroot']."addons/tiger_newhu/template/mobile/qtz/images/hhqd.jpg";
		$title="好货清单";
...
// 							exit;
       ...
       include $this->template ( 'qtz/hhqd1111' );
?>
