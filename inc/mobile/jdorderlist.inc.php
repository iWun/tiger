          ...
          // print_r($order);
           // exit;
            foreach($order as $k=>$v){
                ...
                $tkorder = pdo_fetch("select * from ".tablename($this->modulename."_jdorder")." where weid='{$_W['uniacid']}' and 	orderId='{$v['orderid']}'");
...
//                     }
                        ...
                        if($tkorder['validCode']==17 || $tkorder['validCode']==18){
                            if($v['sh']==2){
                              continue;
                            }
                            //echo $v['sh'];
