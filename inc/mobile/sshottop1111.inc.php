...
global $_W, $_GPC;
       ...
       $weid=$_W['uniacid'];
		...
		$url="https://mo.m.taobao.com/union/1111_ys_rexiao?pid=".$pid."&cpsrc=tiger_tiger";
		$pic=$_W['siteroot']."addons/tiger_newhu/template/mobile/qtz/images/sshottop.jpg";
		$title="1212实时热销榜";
...
// 							exit;
       ...
       include $this->template ( 'qtz/sshottop1111' );
?>
