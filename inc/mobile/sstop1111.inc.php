...
global $_W, $_GPC;
       ...
       $weid=$_W['uniacid'];
		...
		$url="http://mo.m.taobao.com/union/1111_retui?pid=".$pid."&cpsrc=tiger_tiger";
		$pic=$_W['siteroot']."addons/tiger_newhu/template/mobile/qtz/images/banner.jpg";
		$title="1212好货热销榜";
...
// 							exit;
       ...
       include $this->template ( 'qtz/sstop1111' );
?>
