...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_faquan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) DEFAULT '0',
  `type` varchar(250) DEFAULT '0',
  `title` varchar(250) DEFAULT '0',
...
if(!pdo_fieldexists('tiger_newhu_faquan','id')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD 
  `id` int(11) NOT NULL AUTO_INCREMENT");}
if(!pdo_fieldexists('tiger_newhu_faquan','weid')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `weid` int(11) DEFAULT '0'");}
if(!pdo_fieldexists('tiger_newhu_faquan','type')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `type` varchar(250) DEFAULT '0'");}
if(!pdo_fieldexists('tiger_newhu_faquan','title')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `title` varchar(250) DEFAULT '0'");}
if(!pdo_fieldexists('tiger_newhu_faquan','content')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `content` text");}
if(!pdo_fieldexists('tiger_newhu_faquan','piclist')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `piclist` text");}
if(!pdo_fieldexists('tiger_newhu_faquan','createtime')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_faquan')." ADD   `createtime` int(10) NOT NULL");}
...
pdo_query("CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_newtbgoods` (
  ...
  KEY `fqcat` (`fqcat`),
  KEY `tj` (`tj`)
) ENGINE=MyISAM AUTO_INCREMENT=271467 DEFAULT CHARSET=utf8;
...
if(!pdo_fieldexists('tiger_newhu_share','dytype')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_share')." ADD   `dytype` int(3) DEFAULT '0'");}
...
if(!pdo_fieldexists('tiger_newhu_share','pid')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_share')." ADD   KEY `pid` (`pid`)");}
if(!pdo_fieldexists('tiger_newhu_share','xcxopenid')) {pdo_query("ALTER TABLE ".tablename('tiger_newhu_share')." ADD   KEY `xcxopenid` (`xcxopenid`)");}
